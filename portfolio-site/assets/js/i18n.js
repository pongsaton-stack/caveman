...
const STRINGS = {
  th: {
    ...
    tagsLabel: "แท็ก (คั่นด้วยจุลภาค, สูงสุด 5 แท็ก)",
  ...
  en: {
    ...
    tagsLabel: "Tags (comma-separated, up to 5)",
    ...
    reportWork: "🚩 Report this work",
    reportComment: "Report",
    reportTitle: "Report content",
    reportReasonLabel: "Reason",
    reportReasonSpam: "Spam",
    reportReasonInappropriate: "Inappropriate content",
    reportReasonIllegal: "Illegal / harmful",
    reportReasonOther: "Other",
    reportNoteLabel: "Additional details (optional)",
    reportSubmit: "Submit report",
    reportSuccess: "Report sent — thanks for helping keep the community safe.",
    reportNeedSignIn: "Sign in before you can report content",
