...
| บอส B1 + อาวุธ 28 prof 16/20/22 | ~55/84/91% | — | มีดทำครัว (14) ชนะแค่ 2-10% = ตั้งใจ |
ยืนยันใน Godot 4.7.1 จริงแล้ว 25 ก.ย. 2026 (ยกเว้นบอส B1 ที่ Sim ยังไม่มี) — ดู `docs/SIM_REPORT_2026-09-25.md`
...
## งานถัดไปตามลำดับ
1. ✅ รัน Sim headless → เทียบตารางเป้า (`docs/SIM_REPORT_2026-09-25.md`) · ต่อไป: เพิ่มสถานการณ์บอส B1 เข้า Sim
